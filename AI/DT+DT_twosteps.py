...
def DT(X_train, y_train, X_test, y_test):
    ...
    clf_en = DecisionTreeClassifier(criterion='entropy', max_depth=25, random_state=15)

    # fit the model
    clf_en.fit(X_train, y_train)
    y_preds = clf_en.predict(X_train)
    from sklearn.metrics import accuracy_score
    print('Model accuracy score with criterion entropy: {0:0.4f}'. format(accuracy_score(y_train, y_preds)))
...
# be monitored
###### Decision Tree Classifier with criterion gini index
def DT2(X_train, y_train, X_test, y_test):
    # import DecisionTreeClassifier
    from sklearn.tree import DecisionTreeClassifier
    ##### Decision Tree Classifier with with criterion entropy
...
print("The time of execution of above program is :",
    ...
    #DT2(X_train, y_train, X_test, y_test),
